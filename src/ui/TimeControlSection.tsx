...
function configMatchesPreset(config: TimeControlConfig | null, preset: TimeControlPreset): boolean {
...
function findMatchingPresetId(config: TimeControlConfig | null): string {
...
const MODE_OPTIONS: { value: TimeControlMode; label: string }[] = [
